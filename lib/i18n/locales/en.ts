export default {
  ...
  journal: {
    ...
    addFlow: {
      ...
      selectOrEnter: 'Select a recent scan or enter manually',
      enterManually: 'Enter food manually',
      foodPlaceholder: 'e.g., Grilled chicken salad',
      recentScans: 'Recent scans',
      searchFoods: 'Search foods...',
      showLess: 'Show less',
      viewAllScans: 'View all {{count}} scans',
      noMatches: 'No matches found',
      tryDifferentSearch: 'Try a different search',
      noRecentScans: 'No recent scans',
      useManualEntry: 'Use manual entry above',
      howDidItMakeYouFeel: 'How did it make you feel?',
      afterEating: 'After eating {{food}}',
      feltGreat: 'Felt Great',
      justOkay: 'Just Okay',
      feltBad: 'Felt Bad',
      noIssues: 'No issues at all',
      minorDiscomfort: 'Minor discomfort',
      triggeredSymptoms: 'Triggered symptoms',
      addMoreDetails: 'Add more details',
      allFieldsOptional: 'All fields are optional',
      typeOfMeal: 'Type of meal',
      howSevere: 'How severe?',
      whenSymptomsAppear: 'When did symptoms appear?',
      rightAway: 'Right away',
      energyAfterEating: 'Energy after eating?',
      additionalNotes: 'Additional notes',
      notesPlaceholder: 'Add any notes about this meal...',
