export default {
  ...
  home: {
    ...
    // Free scans banner
    freeScans: {
      remaining: '{{count}} sur {{max}} scans gratuits',
      lastScan: 'Plus qu\'1 scan gratuit !',
      allUsed: 'Plus de scans gratuits',
      upgradeCta: 'Appuyez pour débloquer les scans illimités',
    },
  },
  ...
  paywall: {
    ...
    features: {
      ...
      foodJournal: {
        ...
        description: 'Suivez les réactions et découvrez vos déclencheurs',
      },
      bloodSugar: {
  ...
  journal: {
    title: 'Journal Alimentaire',
    addEntry: 'Enregistrer Réaction',
    premium: {
      badge: 'Premium',
      title: 'Débloquer le Journal Alimentaire',
      description: 'Suivez comment les aliments affectent votre corps et découvrez vos déclencheurs personnels avec notre journal alimentaire premium.',
      feature1: 'Enregistrez repas et réactions',
      feature2: 'Surveillez vos niveaux d\'énergie',
      feature3: 'Construisez des séries saines',
      unlock: 'Débloquer Premium',
    },
    editEntry: 'Modifier Réaction',
    // Add/Edit flow
    addFlow: {
      whatDidYouEat: 'Qu\'avez-vous mangé?',
      selectOrEnter: 'Sélectionnez un scan récent ou saisissez manuellement',
      enterManually: 'Saisir l\'aliment manuellement',
      foodPlaceholder: 'ex., Salade de poulet grillé',
      recentScans: 'Scans récents',
      searchFoods: 'Rechercher des aliments...',
      showLess: 'Afficher moins',
      viewAllScans: 'Voir les {{count}} scans',
      noMatches: 'Aucune correspondance',
      tryDifferentSearch: 'Essayez une autre recherche',
      noRecentScans: 'Aucun scan récent',
      useManualEntry: 'Utilisez la saisie manuelle ci-dessus',
      howDidItMakeYouFeel: 'Comment vous êtes-vous sentie?',
      afterEating: 'Après avoir mangé {{food}}',
      feltGreat: 'Je me suis sentie bien',
      justOkay: 'Correct',
      feltBad: 'Je me suis sentie mal',
      noIssues: 'Aucun problème',
      minorDiscomfort: 'Légère gêne',
      triggeredSymptoms: 'A provoqué des symptômes',
      addMoreDetails: 'Ajouter plus de détails',
      allFieldsOptional: 'Tous les champs sont optionnels',
      typeOfMeal: 'Type de repas',
      howSevere: 'Quelle gravité?',
      whenSymptomsAppear: 'Quand les symptômes sont-ils apparus?',
      rightAway: 'Tout de suite',
      energyAfterEating: 'Énergie après avoir mangé?',
      additionalNotes: 'Notes supplémentaires',
      notesPlaceholder: 'Ajoutez des notes sur ce repas...',
    ...
    noEntries: {
      title: 'Aucune réaction enregistrée',
      description: 'Suivez comment les aliments vous affectent pour découvrir vos déclencheurs personnels',
      cta: 'Enregistrez Votre Première Réaction',
    },
    noMeals: {
      title: 'Aucun repas enregistré',
      description: 'Appuyez pour ajouter votre premier repas',
      cta: 'Ajouter Repas',
    },
    mealType: {
      title: 'Type de Repas',
    ...
    food: {
      selectFood: 'Sélectionner Aliment',
      recentScans: 'Scans Récents',
      manualEntry: 'Saisie Manuelle',
      foodName: 'Nom de l\'Aliment',
      foodNamePlaceholder: 'ex., Yaourt Grec aux Fruits Rouges',
      noRecentScans: 'Aucun scan récent. Scannez d\'abord un aliment ou saisissez manuellement.',
    },
    reaction: {
      title: 'Comment vous êtes-vous sentie?',
      good: 'Bien',
      goodDesc: 'Je me suis sentie bien!',
      okay: 'Correct',
      okayDesc: 'Pas de problème',
      bad: 'Mal',
      badDesc: 'A causé des problèmes',
    },
    symptoms: {
      title: 'Des symptômes?',
      ...
      fatigue: 'Fatigue',
      brainFog: 'Brouillard Mental',
      skinBreakout: 'Éruption Cutanée',
      cravings: 'Envies',
    },
    severity: {
      title: 'Quelle gravité?',
      mild: 'Léger',
      moderate: 'Modéré',
      severe: 'Sévère',
    },
    timeAfter: {
      title: 'Quand les symptômes sont-ils apparus?',
    ...
    energy: {
      title: 'Niveau d\'énergie après avoir mangé',
      low: 'Bas',
      normal: 'Normal',
      high: 'Énergisée',
    },
    notes: {
      title: 'Notes',
      placeholder: 'Tout détail supplémentaire sur comment cet aliment vous a affectée...',
    },
    dates: {
      today: 'Aujourd\'hui',
      yesterday: 'Hier',
    ...
    actions: {
      save: 'Enregistrer Réaction',
      update: 'Mettre à Jour Réaction',
      delete: 'Supprimer',
      deleteConfirm: 'Êtes-vous sûre de vouloir supprimer cette réaction?',
    },
    success: {
      created: 'Réaction enregistrée',
      updated: 'Réaction mise à jour',
      deleted: 'Réaction supprimée',
    },
    errors: {
      noFood: 'Veuillez sélectionner ou saisir un aliment',
      noReaction: 'Veuillez sélectionner comment l\'aliment vous a fait sentir',
      saveFailed: 'Échec de l\'enregistrement de la réaction',
      loadFailed: 'Échec du chargement des réactions',
    },
  },
