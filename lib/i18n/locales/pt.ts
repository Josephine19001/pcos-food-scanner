export default {
  ...
  paywall: {
    ...
    features: {
      ...
      foodJournal: {
        ...
        description: 'Acompanhe reações e descubra seus gatilhos',
      },
      bloodSugar: {
  ...
  journal: {
    title: 'Diário Alimentar',
    addEntry: 'Registrar Reação',
    premium: {
      badge: 'Premium',
      title: 'Desbloquear Diário Alimentar',
      description: 'Acompanhe como os alimentos afetam seu corpo e descubra seus gatilhos pessoais com nosso diário alimentar premium.',
      feature1: 'Registre refeições e reações',
      feature2: 'Monitore níveis de energia',
      feature3: 'Construa sequências saudáveis',
      unlock: 'Desbloquear Premium',
    },
    editEntry: 'Editar Reação',
    noEntries: {
      title: 'Nenhuma reação registrada',
      description: 'Acompanhe como os alimentos afetam você para descobrir seus gatilhos pessoais',
      cta: 'Registre Sua Primeira Reação',
    },
    noMeals: {
      title: 'Nenhuma refeição registrada',
      description: 'Toque para adicionar sua primeira refeição',
      cta: 'Adicionar Refeição',
    },
    mealType: {
    ...
    food: {
      ...
      foodNamePlaceholder: 'ex., Iogurte Grego com Frutas Vermelhas',
      noRecentScans: 'Nenhum escaneamento recente. Escaneie um alimento primeiro ou insira manualmente.',
    },
    reaction: {
      title: 'Como você se sentiu?',
      good: 'Bem',
      goodDesc: 'Me senti ótima!',
      okay: 'Ok',
      okayDesc: 'Sem problemas',
      bad: 'Mal',
      badDesc: 'Causou problemas',
    },
    symptoms: {
      title: 'Algum sintoma?',
    ...
    timeAfter: {
      title: 'Quando os sintomas apareceram?',
    ...
    energy: {
      title: 'Nível de energia depois de comer',
      low: 'Baixo',
      normal: 'Normal',
      high: 'Energizada',
    },
    notes: {
      title: 'Notas',
      placeholder: 'Qualquer detalhe adicional sobre como este alimento afetou você...',
    },
    dates: {
      today: 'Hoje',
      yesterday: 'Ontem',
    ...
    actions: {
      save: 'Salvar Reação',
      update: 'Atualizar Reação',
      delete: 'Excluir',
      deleteConfirm: 'Tem certeza que deseja excluir esta reação?',
    },
    success: {
      created: 'Reação registrada',
      updated: 'Reação atualizada',
      deleted: 'Reação excluída',
    },
    errors: {
      noFood: 'Por favor, selecione ou insira um alimento',
      noReaction: 'Por favor, selecione como o alimento fez você se sentir',
      saveFailed: 'Falha ao salvar a reação',
      loadFailed: 'Falha ao carregar as reações',
    },
  },
