      ...
      {selectedFoods.map((item) => {
        ...
        return (
          <View
            key={item.food.id}
            className={themed(
              'bg-white rounded-xl p-4 mb-2 border border-gray-100',
              'bg-gray-800 rounded-xl p-4 mb-2 '
            )}
          >
              ...
              <View className="flex-row items-center">
                {!isEditing ? (
                  <>
                    ...
                    <Text
                      className={themed(
                        'mx-3 font-semibold text-gray-900',
                    ...
                    <TouchableOpacity
                      ...
                      className={themed(
                        'ml-2 w-8 h-8 bg-blue-100 rounded-full items-center justify-center',
                        'ml-2 w-8 h-8 bg-blue-900/30 rounded-full items-center justify-center'
                      )}
                    >
            ...
            {isEditing ? (
              <View className="flex flex-col gap-2">
                ...
                <View className="flex-row items-center justify-between">
                  ...
                  <TextInput
                    ...
                    className={themed(
                      'bg-gray-50 rounded-lg px-3 py-2 text-sm text-gray-900 min-w-20 text-center',
                      'bg-gray-700 rounded-lg px-3 py-2 text-sm text-white min-w-20 text-center'
                    )}
                  />
                </View>
                ...
                <View className="flex-row justify-between">
                  <View className="flex-1 mr-2">
                    ...
                    <TextInput
                      ...
                      keyboardType="numeric"
                      className={themed(
                        'bg-gray-50 rounded-lg px-2 py-1 text-xs text-gray-900 text-center',
                        'bg-gray-700 rounded-lg px-2 py-1 text-xs text-white text-center'
                      )}
                    />
                  </View>
              ...
              <View
                className={themed(
                  'flex-row justify-between pt-2 border-t border-gray-50',
                  'flex-row justify-between pt-2 border-t '
                )}
              >
