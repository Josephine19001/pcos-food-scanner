  ...
  return (
    <>
      ...
      <View className={`${isDark ? 'bg-card-dark' : 'bg-white'} rounded-2xl p-6 mb-4 shadow-sm`}>
        <View className={`h-4 ${isDark ? 'bg-gray-600' : 'bg-gray-200'} rounded mb-4 w-48`} />
          ...
          <View className={`flex-row items-center justify-between ${isDark ? 'bg-gray-700' : 'bg-gray-50'} p-4 rounded-xl`}>
            <View className="flex-row items-center">
              <View className={`${isDark ? 'bg-orange-900/30' : 'bg-orange-100'} p-3 rounded-full`}>
                <View className={`w-7 h-7 ${isDark ? 'bg-gray-600' : 'bg-gray-200'} rounded`} />
              </View>
              <View className="ml-4">
                <View className={`h-3 ${isDark ? 'bg-gray-600' : 'bg-gray-200'} rounded mb-2 w-16`} />
                <View className={`h-8 ${isDark ? 'bg-gray-600' : 'bg-gray-200'} rounded w-20`} />
              </View>
            </View>
            <View className={`${isDark ? 'bg-gray-600' : 'bg-white'} p-3 rounded-full shadow-sm`}>
              <View className={`w-4 h-4 ${isDark ? 'bg-gray-700' : 'bg-gray-200'} rounded`} />
            </View>
          </View>
      ...
      <View className={`${isDark ? 'bg-card-dark' : 'bg-white'} rounded-2xl p-6 mb-4 shadow-sm`}>
        <View className={`flex-row items-center justify-between ${isDark ? 'bg-gray-700' : 'bg-gray-50'} p-4 rounded-xl`}>
          <View className="flex-row items-center">
            ...
            <View className="ml-4">
              <View className={`h-3 ${isDark ? 'bg-gray-600' : 'bg-gray-200'} rounded mb-2 w-24`} />
              <View className={`h-8 ${isDark ? 'bg-gray-600' : 'bg-gray-200'} rounded w-20`} />
            </View>
          </View>
          <View className={`${isDark ? 'bg-gray-600' : 'bg-white'} p-3 rounded-full shadow-sm`}>
      ...
      <View className={`${isDark ? 'bg-card-dark' : 'bg-white'} rounded-2xl p-6 mb-4 shadow-sm`}>
        <View className="flex-row items-center mb-4">
          ...
          <View className="flex-1">
            <View className={`h-4 ${isDark ? 'bg-gray-600' : 'bg-gray-200'} rounded mb-2 w-20`} />
