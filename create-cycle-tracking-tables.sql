-- ================================================================
-- Cycle Tracking Complete Database Schema
...
-- ================================================================
-- 4. USER SUPPLEMENTS TABLE (User's supplement list)
-- ================================================================
CREATE TABLE IF NOT EXISTS public.user_supplements (
  ...
  days_of_week JSONB DEFAULT '["Daily"]'::jsonb, -- For non-daily supplements
...
-- ================================================================
-- 5. BEAUTY PRODUCT RECOMMENDATIONS TABLE
-- ================================================================
CREATE TABLE IF NOT EXISTS public.beauty_recommendations (
  ...
  product_category TEXT NOT NULL, -- cleanser, moisturizer, serum, etc.
...
-- ================================================================
-- 6. Update scanned_products table with cycle insights (if not already done)
-- ================================================================
DO $$ 
BEGIN
...
-- Beauty Recommendations Policies (read-only for users)
CREATE POLICY "Users can view beauty recommendations" ON public.beauty_recommendations
    FOR SELECT USING (true); -- Public recommendations

CREATE POLICY "Admins can manage beauty recommendations" ON public.beauty_recommendations
...
-- ================================================================
-- 12. INSERT DEFAULT BEAUTY RECOMMENDATIONS
-- ================================================================
...
BEGIN
    ...
    RAISE NOTICE 'Tables created: cycle_settings, period_logs, supplement_logs, user_supplements, beauty_recommendations';
    RAISE NOTICE 'RLS policies enabled for all tables';
    RAISE NOTICE 'Default beauty recommendations inserted';
    RAISE NOTICE 'Ready for edge functions!';
END $$;
